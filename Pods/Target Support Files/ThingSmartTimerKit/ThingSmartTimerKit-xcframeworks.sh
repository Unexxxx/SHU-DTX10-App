...
{
  case "$1" in
  "ThingSmartTimerKit.xcframework/ios-arm64")
    echo ""
    ;;
...
install_xcframework "${PODS_ROOT}/ThingSmartTimerKit/Build/ThingSmartTimerKit.xcframework" "ThingSmartTimerKit" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
