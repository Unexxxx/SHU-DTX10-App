...
install_xcframework "${PODS_ROOT}/ThingAnnotationFoundation/ThingAnnotationFoundation.xcframework" "ThingAnnotationFoundation" "framework" "ios-arm64" "ios-x86_64-simulator"
