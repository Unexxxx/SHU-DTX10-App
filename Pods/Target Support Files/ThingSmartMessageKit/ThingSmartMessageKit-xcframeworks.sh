...
install_xcframework "${PODS_ROOT}/ThingSmartMessageKit/Build/ThingSmartMessageKit.xcframework" "ThingSmartMessageKit" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
