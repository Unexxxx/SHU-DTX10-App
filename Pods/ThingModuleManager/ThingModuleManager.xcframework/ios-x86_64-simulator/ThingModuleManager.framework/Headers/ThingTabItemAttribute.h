...
@property (nonatomic, strong) __kindof ThingTabBarCustomButton *customButton;  /** 需要完全自定义tabBarButton时，实现此配置 */
@property (nonatomic, strong) __kindof UIView<ThingTabBarCustomBadgeProtocol> *customBadgeView;   /**< 自定义角标 */
